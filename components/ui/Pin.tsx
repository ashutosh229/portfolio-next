...
export const PinContainer = ({
  ...
  return (
    <a
      ...
      className="group relative rounded-xl border border-white/[0.2] px-4 py-6 shadow-md transition-all hover:border-purple hover:shadow-purple/30 duration-300"
    >
      <div
        className={cn(
