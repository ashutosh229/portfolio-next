...
var require_create_plugin = __commonJS({
  "node_modules/tailwindcss/lib/public/create-plugin.js"(exports) {
    ...
    var _createPlugin = /* @__PURE__ */ _interop_require_default(
      require_createPlugin()
    );
    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": {
            boxShadow:
              "0 0 5px hsl(var(--primary) / 0.5), 0 0 20px hsl(var(--primary) / 0.3)",
          },
          "50%": {
            boxShadow:
...
export { tailwind_config_default as default };
